...
> 현재 버전: **v1.41** (버전 규칙: 대시보드 메뉴 1개당 버전 1 — 메뉴 11개. v1.20~v1.41은 새 메뉴 없이 기존 기능을 고도화한 기능 릴리스)
...
| 메뉴 | 구현 내용 | 데이터 출처 |
|------|-----------|-------------|
| **전체 현황** | 핵심 운영지표 한눈 요약 — **총매출(장비·라이선스·기타, 노션 실데이터) + 구분 체크박스** 🆕, **CMS 매출(효성CMS 실제 수납액)** 🆕, VAN 건수 (월별·작년 대비) · **유튜브 채널지표 카드** · **데이터 동기화 버튼 + 매일 8시 자동수집** | 노션 매출 DB + 효성CMS + 유튜브 Data API + VAN 자동수집 |
...
> 버전별 상세 문서: **[v1.41](docs/v1.41.md)** · [v1.40](docs/v1.40.md) · [v1.30](docs/v1.30.md) · [v1.20](docs/v1.20.md) · [v1.11](docs/v1.11.md) · [v1.10](docs/v1.10.md) · [v1.3](docs/v1.3.md) · [v1.2](docs/v1.2.md) · [v1.0](docs/v1.0.md) · [v0.1](docs/v0.1.md) (각 버전의 기능·파일별 변경 내역)
>
> 버전 규칙: **대시보드 메뉴 1개당 버전 1 증가**(메뉴 11개 → v1.11). v1.20~v1.40은 새 메뉴 없이 기존 기능을 대폭 고도화한 **기능 릴리스**.
