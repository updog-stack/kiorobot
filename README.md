...
> 현재 버전: **v1.49** (v1.49에서 **가맹점·단말기 지표를 실제 거래 기준으로 재정비** + **아무도없개 매출 자동수집** — 새 메뉴 없는 고도화)
...
| **업무현황** ⬆️ | 노션 [업무 DB] 실시간 집계 — **협업(협업자·요청자) 관계 그래프** 🆕, 담당자별 **내근/외근 상태 직접 변경**·**업무부하 4단계(여유·보통·바쁨·과부하) 자동 판정** 🆕, **이름 클릭 시 담당 업무 내용 열람** 🆕, 진행중·대기·보류·오늘완료·정체 KPI (5분 갱신) | 노션 업무 DB |
| **업무일지** ⬆️ | 매일 **19:00 자동 생성** '데일리 브리핑' 신문형 양식(세줄요약·수치·하루의 흐름·구성원별·성과/진전/걸림돌·내일) 🆕, **캘린더 일자별 누적**·**매월 1일 월간 종합** 🆕, **PDF 저장 + 대표님 슬랙 전송** 🆕, **채널톡 일일 리포트 첨부**(전화·채널톡·카카오 **전부 자동집계**) 🆕. 직원 직접 작성(임의 날짜·시간 제한 없음)도 유지 | 노션 업무 DB + 채널톡 Open API + Claude AI + 슬랙 |
