...
> 현재 버전: **v1.10** (버전 규칙: 대시보드 메뉴 1개당 버전 1 — 현재 메뉴 10개)
...
> 버전별 상세 문서: **[v1.10](docs/v1.10.md)** · [v1.3](docs/v1.3.md) · [v1.2](docs/v1.2.md) · [v1.0](docs/v1.0.md) · [v0.1](docs/v0.1.md) (각 버전의 기능·파일별 변경 내역)
>
